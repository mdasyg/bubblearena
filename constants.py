...
LOCAL_KEY_MAPPINGS = {
    0: {  # Player 1: WASD / Arrow Keys + Space / W / Up (Jump) + F / J / Z / Enter (Shoot)
        "left": [pygame.K_a, pygame.K_LEFT],
        "right": [pygame.K_d, pygame.K_RIGHT],
        "up": [pygame.K_w, pygame.K_UP],
        "down": [pygame.K_s, pygame.K_DOWN],
        "jump": [pygame.K_w, pygame.K_SPACE, pygame.K_UP, pygame.K_g, pygame.K_k],
        "shoot": [pygame.K_f, pygame.K_j, pygame.K_z, pygame.K_RETURN, pygame.K_LCTRL],
        "action": [pygame.K_g, pygame.K_e, pygame.K_x],
        "struggle": [pygame.K_f, pygame.K_j, pygame.K_z, pygame.K_SPACE, pygame.K_w, pygame.K_a, pygame.K_d],
    },
    1: {  # Player 2: Arrow Keys + K (Shoot) + L / Up (Jump) + J (Action)
        "left": [pygame.K_LEFT],
        "right": [pygame.K_RIGHT],
        "up": [pygame.K_UP],
        "down": [pygame.K_DOWN],
        "jump": [pygame.K_UP, pygame.K_l, pygame.K_RCTRL],
        "shoot": [pygame.K_k, pygame.K_RSHIFT, pygame.K_PERIOD],
        "action": [pygame.K_j, pygame.K_SLASH],
        "struggle": [pygame.K_k, pygame.K_l, pygame.K_UP],
    },
    2: {  # Player 3: IJKL + U (Shoot) + O (Jump) + Y (Action)
        ...
        "up": [pygame.K_i],
        "down": [pygame.K_k],
        "jump": [pygame.K_i, pygame.K_o],
        "shoot": [pygame.K_u],
        "action": [pygame.K_y],
        "struggle": [pygame.K_u, pygame.K_o],
    },
    3: {  # Player 4: Numpad 4/5/6/8 + Numpad 7 (Shoot) + Numpad 9 (Jump)
        ...
        "up": [pygame.K_KP8],
        "down": [pygame.K_KP5],
        "jump": [pygame.K_KP8, pygame.K_KP9],
        "shoot": [pygame.K_KP7],
        "action": [pygame.K_KP_ENTER, pygame.K_KP_PLUS],
        "struggle": [pygame.K_KP7, pygame.K_KP9],
    },
}
...
BOT_PERSONALITY_PASSIVE = "Passive"
BOT_PERSONALITY_STANDARD = "Standard"
BOT_PERSONALITIES = [BOT_PERSONALITY_AGGRESSIVE, BOT_PERSONALITY_PASSIVE, BOT_PERSONALITY_STANDARD]
